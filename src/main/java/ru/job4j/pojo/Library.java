...
public class Library {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < books.length; i++) {
            System.out.println("Название книги :" + books[i].getName() + "Количество страниц: " + books[i].getPageSize());
        }
        ...
        for (Book book : books) {
            System.out.println("Название книги :" + book.getName() + "Количество страниц: " + book.getPageSize());
        }
